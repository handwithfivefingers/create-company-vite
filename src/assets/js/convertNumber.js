var LIB = (function (t) {
  ...
  function (t, n, r) {
    ...
    t.exports = function (t, n, r) {
      ...
      if (!l || n < 1) return []
      for (var f = 0, a = 0, s = Array(i(l / n)); f < l; ) s[a++] = e(t, f, (f += n))
      return s
    }
  },
  function (t, n, r) {
    ...
    var e = r(5),
      ...
      c = r(6),
      l = r.n(c)
    const f = { 0: 'không', 1: 'một', 2: 'hai', 3: 'ba', 4: 'bốn', 5: 'năm', 6: 'sáu', 7: 'bẩy', 8: 'tám', 9: 'chín' },
      a = { 1: 'mốt', 4: 'tư', 5: 'lăm' },
      s = (t) => {
        let n = t[0],
          r = t[1]
      ...
      g = (t) => ('000000' === o()(i()(t), '') ? '' : '' === p(t[0]) ? 'không nghìn ' + p(t[1]) : p(t[0]) + ' nghìn ' + p(t[1])),
      v = (t) => {
    ...
    n.default = function (t) {
      ...
      let r = (t = BigInt(t)).toString().split(''),
        e = h(r, 3)
      if ((1 === e.length ? (n += p(e[0])) : 2 === e.length ? (n += g(e)) : 3 === e.length && (n += v(e)), e.length >= 4)) {
        var o = h(e, 3)
        let t = [...o]
        if (
          (t.shift(),
          ...
          1 === o[0].length ? (n += p(e[0])) : 2 === o[0].length ? (n += g(e)) : 3 === o[0].length && (n += v(e))
          ...
          for (let r = 0; r <= o.length - 1; r++) {
            let e = ''
            ;(t -= 1),
              1 === o[r].length ? (e += p(o[r][0])) : 2 === o[r].length ? (e += g(o[r])) : 3 === o[r].length && (e += v(o[r])),
              (n += '' == e ? 'không' : e)
      ...
      return (n = (n = (n = (n = (n = (n = n.replace(/(\s)+/gi, ' ')).replace(
        ...
        ' ',
      )).replace(/(\s)+/gi, ' ')).replace(/không triệu không nghìn/gi, ' ')).replace(/(\s)+/gi, ' ')).replace())
    }
  },
  function (t, n, r) {
    var e = r(9),
    ...
    t.exports = function t(n, r, u, i, c) {
      ...
      for (u || (u = o), c || (c = []); ++l < f; ) {
        var a = n[l]
        r > 0 && u(a) ? (r > 1 ? t(a, r - 1, u, i, c) : e(c, a)) : i || (c[c.length] = a)
      }
      return c
    }
  },
