...
export const SELECT = {
  ...
  CONTRIBUTE: [
    {
      name: 'Chuyển nhượng toàn bộ phần vốn góp',
      value: 'Chuyển nhượng toàn bộ phần vốn góp',
    },
    {
      name: 'Chuyển nhượng một phần vốn góp',
      value: 'Chuyển nhượng một phần vốn góp',
    },
  ],
  OWNER: [
    {
