...
const withAttachments = async (
  req,
  res,
  { adminEmail, email, subject, content, redirect },
  transporter,
) => {
  let attachments
  try {
    let validFiles = req.files.some(
...
const sendMail = async (
  req,
  res,
  { adminEmail, email, subject, content, redirect, ...rest },
  transporter,
) => {
  try {
    // console.log("send");
